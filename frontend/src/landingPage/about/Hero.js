function Hero() {
  return (
    <div className="container">
      <div className="text-muted p-5 mb-5">
        <h1 className="text-center fs-3 mb-5">
          We pioneered the discount broking model in India.
          <br />
          Now, we are breaking ground with our technology.
        </h1>
      </div>
      <div className="row text-muted p-5 border-top fs-5" style={{"line-height":45}}>
        ...
        <div className="col-6 p-5 ">
          <p>
            ...
            <p><a href="" style={{"text-decoration":"none"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several
